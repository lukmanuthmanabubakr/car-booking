...
import { assets, menuLinks } from "../assets/assets"; // Adjust the path as necessary
    ...
    >
      ...
      >
        {menuLinks.map((link, index) => (
          <Link key={index} to={link.path} className="mx-4 text-sm">
            {link.name}
          </Link>
        ))}

        <div className="hidden sm:flex items-center text-sm gap-2 border border-borderColor px-3 rounded-full max-w-56">
          <input
            type="text"
